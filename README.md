...
- **Infrastructure & Cloud**: Kubernetes (K3s), Ansible, Terraform, AWS
- **Languages**: Python, Go, Shell scripting, HCL
- **Leadership**: High-performance team management, engineering coaching
- **Specialties**: Infrastructure Security, Cloud Architecture, Systems Design
...
- Cloud and systems architecture projects
- High-performance team management initiatives
- Leadership coaching
